...
public class UserService {
    ...
    public void cadastrarUsuario(@Valid NewUserDTO newUser) {
        ...
        ticketService.createTicketsForNewUser(
                user.getId(),
        ...
        notificationService.sendNotification(
                ...
                "Parabéns %s, sua conta foi criada com sucesso. Bem-vindo a bordo do nosso espetacular serviço de usuários. lorem ipsum dolor nocet"
                        .formatted(user.getProfile().getName()));
    }
